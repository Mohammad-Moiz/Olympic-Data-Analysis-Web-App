...
def data_over_time(df, col):
    ...
    nations_over_time.rename(columns={'index': 'region', 'Year': col}, inplace=True)
    if 'region' in nations_over_time.columns:
            nations_over_time.sort_values(by='region', inplace=True)
